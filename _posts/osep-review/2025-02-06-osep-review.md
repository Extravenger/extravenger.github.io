...
Each topic is covered in depth, and Offsec has done a great job explaining each one.<br>
...
Another example is when you exploit a vulnerability or misconfiguration with one tool, try exploiting it again using a different tool than before.
