...
This involves cloning the source code of Rubeus, opening it in Visual Studio, and then changing some commonly used names—starting with the word "Rubeus.exe"
